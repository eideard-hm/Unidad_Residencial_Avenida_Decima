$(document).ready(function(){
	...
	$('#button-menu').click(function(){
		if($('#button-menu').attr('class') == 'fa fa-bars' ){
			...
			$('.navegacion .submenu').css({'left':'-330px'}); // Ocultamos los submenus
			$('.navegacion .menu').css({'left':'-330px'}); // Ocultamos el Menu
	...
	$('.navegacion .submenu li.go-back').click(function(){
		...
		$(this).parent().css({'left':'-330px'}); // Ocultamos el submenu
